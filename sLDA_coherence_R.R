...
# Load data
df <- read.csv("C:/Users/arya1999/Desktop/sLDA AVH/datasets_final/coherencetext_training.csv")
for_prediction <- read.csv("C:/Users/arya1999/Desktop/sLDA AVH/datasets_final/coherencetext_test.csv")
...
df <- df %>% 
  select(numscores, text_manual)

# Rename variables
df <- df %>%
  rename(clinical = numscores,
         text = text_manual)
